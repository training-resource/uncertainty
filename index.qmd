...
::: callout-important
## Causal Dependence in Forest Ecology
...
-   Chapter 3 Activity Data Uncertainty: Significant uncertainty reductions can be achieved through enhanced reference data collection and data cube processing informing improved image classification algorithms; multi-temporal validation datasets and noise signal seperation; systematic accuracy assessment protocols.
...
[^index-4]: i.e., <https://seamusmurphy.shinyapps.io/winrock-monte-carlo/>
