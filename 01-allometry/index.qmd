...
::: callout-note
While Section 8 exempts structural allometric uncertainty
...
reticulate::use_python("/Applications/Xcode.app/Contents/Developer/usr/bin/python3", required = T)
#reticulate::use_python("/Users/seamus/Library/Python/3.9/bin/python3", required = T)
```
...
subprocess.run([sys.executable, "-m", "pip", "install", "-q",
  "contextily", 
  "folium", "geopandas", "kaleido",
  "matplotlib", "numpy", "openpyxl", 
  "pandas", "plotly", "pysal", "pyproj", "rasterio",
  "scikit-learn", "scipy", "seaborn", "statsmodels", "shapely", 
  "xarray"
...
## Allometric Modelling {#sec-allometry-relationship}
...
estimation, and field measurements. Log-transformation adds
complexity through back-transformation bias that must be
corrected to avoid systematic errors in biomass estimations.
...
```{r}
#{webr-r} # Enable this line in markdown to "Run Code"
# head(scbi_stem1) # Top rows only
...
# if needed, visualize all available variables
