...
::: callout-tip
## Allometry Investment Rationale
...
### ~~Environment Setup (Python)~~[^1] {.unnumbered}
...
::: callout-tip
## Complete Species Allometry Dataset
...
4.  Sample Size Adequacy: Minimum n=50 trees for species-specific; n\>150 for genus-level equations[^2]
...
*Description of the allometric studies used to develop each equation and any shared attributes with our field data here....*
...
[^1]: Removal of `python` workflow was requested during first review (November 24, 2025). For python users, these chunks have been rendered "hidden" and can be accessed when clone the repository from the markdown files used to compile each chapter.

[^2]: Follow-up: Allometry Sample Size Guidelines [@roxburgh2015guidelines] = [Link](https://esajournals.onlinelibrary.wiley.com/doi/full/10.1890/ES14-00251.1#sa2).
