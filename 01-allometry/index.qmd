...
subprocess.run([sys.executable, "-m", "pip", "install", "-q",
  "contextily", "folium", "geopandas", "kaleido", "matplotlib", 
  "numpy", "openpyxl", "pandas", "plotly", "pysal", "pyproj", "rasterio",
...
#| echo: true
# tidy
demo_data_py = (demo_data_py
    .query('dbh.notna()')
    .query('dbh >= 5 & dbh <= 100')
)

# check distributions
demo_data_py.describe().T
```
...
::: callout-tip
In this early stage of workflow, it can be useful to take a
quick note of the range and spread in DBH values. This
offers an early indication of statistical operations and
validation checks that may be needed ahead.
:::
