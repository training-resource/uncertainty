...
-   Enhanced grassland management factors: Improved tropical grasslands (F~MG~ = 1.17) versus degraded (0.70) creates \~67% SOC gain potential
...
## 2.3 SOC Grassland Management Factors
...
## 2.4 SOC Cropland Management Factors
...
::: callout-important
## Agroforestry vs. Monoculture Comparison
...
## 2.8 Post-Conversion Stock Retention
...
Conservation agriculture practices (no-till + high inputs) nearly neutralize SOC loss from forest conversion (only -0.18 tCO₂e/ha/yr), but biomass loss remains unavoidable. This demonstrates the importance of:

1.  Avoiding forest conversion where possible
2.  Applying maximum conservation practices when conversion is necessary
3.  Prioritizing conversion of already-degraded lands rather than forest
:::
...
### SOC Temporal Double-Counting {.unnumbered}
...
### Tracking Overlapping Activities
...
For independent variables, total uncertainty is calculated as:

$
U_{total} = \sqrt{(U_1)^2 + (U_2)^2 + ... + (U_n)^2}
$

Where U represents proportional uncertainty (e.g., ±11% → 0.11)
...
::: callout-warning
## Agroforestry Variance

High uncertainty levels of agroforestry growth rate emission factors (±63%) can being to dominate the error budget. When total uncertainty exceeds ±50%, consider the:

1.  Conservative reporting using lower confidence bound
2.  Tier 2 upgrade with site-specific measurements to reduce key parameter uncertainties
:::

## 2.15 Chapter Summary

The following were compiled as critical decison points for program proponents.
...
Table 2.V Highest-Value Emissions Factor Uncertainty Enhancements

| Rank | Activity | Carbon Benefit | Key Considerations |
|----------|------------------------------|-------------------------|-----------------------------------------|
...
| 3 | Young secondary forest protection | 2.77-5.9 tC/ha/yr + avoided loss | High additionality, rapid credits |
