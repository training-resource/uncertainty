## Glossary of Terms[^glossary-terms-1]
...
-   **Coefficient of Variation**
    The ratio of the population standard deviation, $\sigma_x$, and mean, $\mu_x$, where $v_x = \sigma_x / \mu_x$. It is often used to express the standard deviation as a percentage of the mean.
...
-   **Monte Carlo Method**:[^glossary-terms-2] The statistical method recommended to analyse the uncertainty of the inventory. It performs the inventory calculation many times by computer, each time with the uncertain emission factors or model parameters and activity data chosen randomly within the distribution of uncertainties specified by the user.
...
[^glossary-terms-1]: <https://www.ipcc-nggip.iges.or.jp/public/2006gl/pdf/0_Overview/V0_2_Glossary.pdf>

[^glossary-terms-2]: See subsection "A4 Primer on Monte Carlo Methods"
